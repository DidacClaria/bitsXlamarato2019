        ...
        for i in f1:
            ...
            for j in i:
                if ord(j) == 39 and x == 0:
                    ...
                    output.write("<category><pattern> _ ")
                    output.write(name)
                    output.write(" _ </pattern><template>")
                    output.write(newurl)
                    ...
                    output2.write("<category><pattern> _ ")
                    output2.write("SINTOMAS _ " + name)
                    output2.write(" _ </pattern><template>")
